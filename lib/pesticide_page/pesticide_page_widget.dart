...
import 'pesticide_page_model.dart';
export 'pesticide_page_model.dart';

class PesticidePageWidget extends StatefulWidget {
  const PesticidePageWidget({
    super.key,
    String? nitrogenValue,
  }) : nitrogenValue = nitrogenValue ?? '10';

  final String nitrogenValue;

  @override
  State<PesticidePageWidget> createState() => _PesticidePageWidgetState();
}

class _PesticidePageWidgetState extends State<PesticidePageWidget> {
  late PesticidePageModel _model;
